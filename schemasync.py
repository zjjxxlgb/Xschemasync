...
def parse_cmd_line(fn):
    ...
    def processor():
        ...
        parser.add_option("--table",
                         dest="table",
                         default='',
                         help=("sync the special table"))
     
        parser.add_option("--mode",
                         dest="mode",
                         default=0,
                         help=("default 0:all schema change;1:ignore drop table;2:ignore drop column;3:ignore drop table and column;100:only drop table and column"))
...
def app(sourcedb='', targetdb='', version_filename=False,
        ...
        tag=None, charset=None, sync_auto_inc=False, sync_comments=False,table='',mode=0):
    """Main Application"""
